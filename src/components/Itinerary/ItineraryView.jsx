            ...
            {Object.entries(budgetBreakdown).map(([key, val]) => {
              ...
              return (
                <div key={key} className="flex items-center gap-3">
                  <dt className="w-32 shrink-0 text-sm capitalize text-slate-600 dark:text-slate-400">{key}</dt>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        {packingEssentials.length > 0 && (
          <section className="card" aria-labelledby="packing-heading">
            <h2 id="packing-heading" className="mb-3 font-semibold text-slate-800 dark:text-slate-100">🎒 Packing Essentials</h2>
        ...
        {Object.keys(emergencyContacts).length > 0 && (
          <section className="card" aria-labelledby="emergency-heading">
            <h2 id="emergency-heading" className="mb-3 font-semibold text-slate-800 dark:text-slate-100">🆘 Emergency Contacts</h2>
